...
FEAT_PATH="./data/conceptual_captions/features/clip_features"
EXP_NAME="MBART_VMLM_en-fr_CC_from_NMT_adapters_textparamsfrozen_PMask50_CLIP"
EPOCH_SIZE=2000000
seed=12345
...
main.py --beam_size 4 --exp_name ${EXP_NAME} --dump_path ${DUMP_PATH} --features_path ${FEAT_PATH} --features_type 'clip' \
  ...
  --multimodal_model --adapters --freeze_text_parameters --prob_mask_text 0.5 --start_new_xp_from_ckpt $@
