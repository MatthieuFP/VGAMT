...
WANDB_MODE=offline python main.py --beam_size 8 --dump_path ${DUMP_PATH} --data_path ${DATA_PATH} --src_lang 'en' --tgt_lang 'cs' --dropout '0.4' \
  ...
  --reload_model /gpfsstore/rech/ncm/ueh14bh/guided_sa/en-cs/MBART_mix_MT_MLM_en-cs_Multi30k_from_NMT_adapters_textparamsfrozen_mix50_PMask25_LONGER_TRAINING_100minEPOCHS/1882213/best-valid_en-cs_mt_bleu.pth \
