...
WANDB_MODE=offline python main.py --beam_size 4 --exp_name ${EXP_NAME} --dump_path ${DUMP_PATH} --features_path ${FEAT_PATH_COCO} --features_type 'mdetr+clip' \
  ...
  --reload_model /gpfsstore/rech/ncm/ueh14bh/guided_sa/en-fr/MBART_mix_MMT_VMLM_en-fr_Multi30k_from_NMT_adapters_textparamsfrozen_CLIPMDETR_mix50_PMask25_NOGUIDEDSA/1232621/best-valid_en-fr_mt_bleu.pth \
  --eval_only true --test_data_set test_2017_mscoco --multimodal_model --encoder_attn_mask_text_only --adapters $@
...
WANDB_MODE=offline python main.py --beam_size 4 --exp_name ${EXP_NAME} --dump_path ${DUMP_PATH} --features_path ${FEAT_PATH_FLICKR17} --features_type 'mdetr+clip' \
  ...
  --cache_dir ${CACHE_HUGGINGFACE} --amp 1 --fp16 True --accumulate_gradients 16 \
  --reload_model /gpfsstore/rech/ncm/ueh14bh/guided_sa/en-fr/MBART_mix_MMT_VMLM_en-fr_Multi30k_from_NMT_adapters_textparamsfrozen_CLIPMDETR_mix50_PMask25_NOGUIDEDSA/1232621/best-valid_en-fr_mt_bleu.pth \
  --eval_only true --test_data_set test_2017_flickr --multimodal_model --encoder_attn_mask_text_only --adapters $@
...
WANDB_MODE=offline python main.py --beam_size 4 --exp_name ${EXP_NAME} --dump_path ${DUMP_PATH} --features_path ${FEAT_PATH_FLICKR16} --features_type 'mdetr+clip' \
  ...
  --cache_dir ${CACHE_HUGGINGFACE} --amp 1 --fp16 True --accumulate_gradients 16 \
  --reload_model /gpfsstore/rech/ncm/ueh14bh/guided_sa/en-fr/MBART_mix_MMT_VMLM_en-fr_Multi30k_from_NMT_adapters_textparamsfrozen_CLIPMDETR_mix50_PMask25_NOGUIDEDSA/1232621/best-valid_en-fr_mt_bleu.pth \
  --eval_only true --multimodal_model --encoder_attn_mask_text_only --adapters $@


# --guided_self_attention --encoder_attn_mask_text_only --adapters