...
WANDB_MODE=offline python main.py --beam_size 8 --dump_path ${DUMP_PATH} --data_path ${DATA_PATH} --src_lang 'en' --tgt_lang 'fr' --dropout '0.4' \
  ...
  --stopping_criterion 'valid_en-fr_mt_bleu,50' --validation_metrics 'valid_en-fr_mt_bleu' --iter_seed ${seed} --other_seed ${seed} --smoothing 0.0 \
