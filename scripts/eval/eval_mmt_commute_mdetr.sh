...
FEAT_PATH="./data/commute/homograph/mdetr_features/array_format/standard"
seed=12345

WANDB_MODE=offline python main.py --beam_size 8 --dump_path ${DUMP_PATH} --features_path ${FEAT_PATH} --features_type 'mdetr' \
  ...
  --eval_only true --multimodal_model --encoder_attn_mask_text_only --test_data_set commute --adapters --guided_self_attention $@
