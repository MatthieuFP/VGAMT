...
FEAT_PATH_MIX="./data/conceptual_captions/features/mdetr_features"
EXP_NAME="MBART_mix_MMT_VMLM_en-fr_Multi30k_from_NMT_adapters_guidedSA_textparamsfrozen_MDETR_mix50_PMask25"
EPOCH_SIZE=58000
seed=42
...
main.py --beam_size 4 --exp_name ${EXP_NAME} --dump_path ${DUMP_PATH} --features_path ${FEAT_PATH}  --features_type 'mdetr' \
  ...
  --mix_xp .5 --prob_mask_text 0.25 --encdec_vmlm --guided_self_attention $@